package hsf302.he187383.phudd.client;

import hsf302.he187383.phudd.client.config.AppConfig;
import hsf302.he187383.phudd.client.dto.LoginRequest;
import hsf302.he187383.phudd.client.dto.LoginResponse;
...
//            }
    ...
    public void heartbeat(String jti, String deviceId) throws ClientException {
        ...
        try {
            ...
            try {
                var payload = new com.fasterxml.jackson.databind.ObjectMapper()
                        .readValue(e.getResponseBodyAsByteArray(), hsf302.he187383.phudd.client.dto.ErrorPayload.class);
                throw new ClientException(payload.getError(), payload.getError_description());
            } catch (Exception ignore) {
                throw new ClientException("http_error", e.getStatusCode() + " " + e.getMessage());
            }
